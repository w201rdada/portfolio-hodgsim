...
knitr::include_url('https://player.vimeo.com/video/245095323')
```
...
```{r hello-world,echo=FALSE,fig.cap='',fig.align='center',out.width='80%'}
knitr::include_graphics('img/Kiva2.jpg')
```
