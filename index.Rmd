...
```{r hello-world,echo=FALSE,fig.cap='',fig.align='center',out.width='50%'}
knitr::include_graphics('img/Kiva.jpg')
```
...
<p>
```{r hello-benji,echo=FALSE,fig.cap='',fig.align='center'}
knitr::include_url('https://drive.google.com/file/d/1UphYOL8bGxQPz_kRJgBJ33-N8uaRLilq/view?usp=sharing')
```
